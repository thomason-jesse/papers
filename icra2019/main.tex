...
\author{{\color{blue}\bf \large Jesse Thomason},$^*$ Aishwarya Padmakumar,$^\dagger$ Jivko Sinapov,$^\ddagger$ Nick Walker,$^*$ Yuqian Jiang,$^\dagger$\\Harel Yedidsion,$^\dagger$ Justin Hart,$^\dagger$ Peter Stone,$^\dagger$ and Raymond J. Mooney$^\dagger$}
